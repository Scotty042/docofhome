...
export const handbookSections: HandbookSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'fi-rcd', term: 'FI / RCD', aliases: ['FI', 'RCD', 'Fehlerstromschutzschalter'], category: 'electrical', summary: 'Fehlerstrom-Schutzeinrichtung für eine Gruppe von Stromkreisen.', details: 'Ein FI/RCD überwacht, ob Strom unerwartet abfließt. In DocOfHome kann er optional einer Phasen-/Kammschiene und einer N-Schiene zugeordnet werden, damit die zugehörige Gruppe verständlich bleibt. Eine allgemeine Sammelschiene besitzt dagegen keine automatische FI-Gruppen- oder TE-Phasenlogik.', example: 'FI „EG Allgemein“ → Phasenschiene/Kammschiene → Sicherungen für Flur, Wohnzimmer und Küche.', related: ['FI-Gruppe', 'N-Schiene', 'Phasenschiene / Kammschiene'] },
      ...
      { id: 'phasen', term: 'Phase L1, L2, L3', aliases: ['L1', 'L2', 'L3', 'Phasen'], category: 'electrical', summary: 'Drei aktive Leiter eines üblichen dreiphasigen Hausanschlusses.', details: 'Die Lasten werden möglichst sinnvoll auf L1, L2 und L3 verteilt. DocOfHome leitet die Phase nur bei einer Phasen-/Kammschiene aus Startphase und TE-Position ab. Eine allgemeine Sammelschiene gibt keine positionsabhängige Phase vor.', example: 'Eine dreiphasige Kammschiene wiederholt das Muster L1 – L2 – L3.', related: ['Phasenschiene / Kammschiene', 'Phasenverteilerblock', 'Neutralleiter N'] },
      ...
      },
      {
        ...
        details: 'Die Kontakte sehen wie die Zähne eines Kamms aus und werden direkt in die Anschlussklemmen nebeneinanderliegender FI-, LS- oder FI/LS-Geräte eingesetzt. Dadurch ersetzt die Kammschiene viele einzelne Drahtbrücken innerhalb einer DIN-Reihe. Ein- und mehrphasige Ausführungen können ein festes Muster wie L1–L2–L3 wiederholen. Nicht jede Sammelschiene ist eine Kammschiene; eine Kammschiene verbindet direkt nebeneinanderliegende Reiheneinbaugeräte und übernimmt dort die Funktion einer kleinen Sammelschiene. DocOfHome erzeugt für jedes vollständig überdeckte DIN-Gerät automatisch eine schreibgeschützte Verbindung und berechnet die Kontaktphase aus Startphase und TE-Position. Bei einem vierpoligen FI werden nur L1, L2 und L3 über die Kammschiene geführt; der vierte Pol bleibt für N frei. Eine FI/RCD-Zuordnung ist optional und wird nur gesetzt, wenn die Schiene tatsächlich hinter diesem FI/RCD liegt. „Sammelschiene“ bleibt der allgemeine, manuell verkabelte Verteilpunkt.',
        ...
        related: ['Sammelschiene', 'FI / RCD', 'Sicherung / Leitungsschutzschalter', 'automatische Phasenzuordnung über eine Phasenschiene']
      },
      ...
      { id: 'automatische-phasenzuordnung', term: 'automatische Phasenzuordnung über eine Phasenschiene', aliases: ['automatische Phasenzuordnung', 'automatische Phasenzuordnung über eine Sammelschiene'], category: 'electrical', summary: 'Verbindliche Ableitung der Phase aus TE-Position und Phasenmuster einer Kammschiene.', details: 'Überdeckt eine Phasen-/Kammschiene ein Schutzgerät vollständig, berechnet DocOfHome die Außenleiterphase anhand von Startphase und wiederholtem L1/L2/L3-Muster. Die daraus erzeugte physische Schienenverbindung ist automatisch und nicht manuell änderbar. Allgemeine Sammelschienen bleiben davon unberührt.', related: ['Phasenschiene / Kammschiene', 'Phase L1, L2, L3'] },
      { id: 'fi-gruppe', term: 'FI-Gruppe', category: 'electrical', summary: 'Zusammengehörige Schutzgeräte, Phasenschiene und Neutralleiter unter einem FI/RCD.', details: 'Eine FI-Gruppe kann durch die optionale Zuordnung einer Phasen-/Kammschiene und einer N-Schiene zu demselben FI/RCD dokumentiert werden. Schutzgeräte im vollständig überdeckten Bereich übernehmen die wirksame FI-Zuordnung; eine Kammschiene ohne FI bleibt ebenfalls zulässig.', example: 'FI → Phasenschiene/Kammschiene → Sicherungen sowie FI → N-Schiene → Neutralleiter derselben Stromkreise.', related: ['FI / RCD', 'N-Schiene', 'Phasenschiene / Kammschiene'] },
