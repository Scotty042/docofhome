...
export const handbookSections: HandbookSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'sammelschiene', term: 'Sammelschiene', category: 'electrical', summary: 'In DocOfHome eine dokumentierte Schiene, die mehrere Geräte gemeinsam versorgt.', details: 'Eine Sammelschiene kann einen TE-Bereich, die Leiter L1/L2/L3, eine Startphase und einen zugehörigen FI besitzen. Geräte unter ihrer Position erhalten daraus automatisch Phase und FI-Gruppe.', example: 'FI → Sammelschiene mit Startphase L1 → Sicherungen auf TE 1 bis 12.', related: ['Phasenschiene / Kammschiene', 'automatische Phasenzuordnung', 'FI-Gruppe'] },
      { id: 'phasenschiene', term: 'Phasenschiene / Kammschiene', aliases: ['Phasenschiene', 'Kammschiene'], category: 'electrical', summary: 'Physische Verbindung zur gemeinsamen Versorgung mehrerer Reihengeräte.', details: 'Eine Phasen- oder Kammschiene verbindet die Einspeiseseite mehrerer Geräte. In DocOfHome kann sie als passive Komponente dokumentiert werden; die Sammelschienenlogik übernimmt zusätzlich die automatische Gruppen- und Phasenzuordnung.', example: 'Ein FI versorgt über eine dreiphasige Kammschiene mehrere Sicherungsautomaten.', related: ['Sammelschiene', 'FI / RCD', 'Phase L1, L2, L3'] },
