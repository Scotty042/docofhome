...
const type = { id: 'type-1', name: 'Smart Home', code_prefix: 'SH', description: null, icon: null, module_width: null, created_at: '', updated_at: '', deleted_at: null } satisfies AssetType
